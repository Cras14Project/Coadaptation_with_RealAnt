...
sac_pso_batch = {
    ...
    'steps_per_episodes' : 20,                # Number of steps per episode
...
sac_pso_sim = {
    ...
    'iterations_init' : 10, # CRAS14: original 10
    'iterations_random': 5, # CRAS14: original 5
    'iterations' : 10, # CRAS14: original 5
    'design_cycles' : 5, # CRAS14: original 5
    'state_batch_size' : 32, # CRAS14: original 32
    'initial_episodes' : 3, # CRAS14: original 3
    'use_gpu' : False,
    'use_cpu_for_rollout': False,
    'cuda_device': 0,
    'exploration_strategy': 'random',
    'design_optim_method' : 'pso_sim',
    'steps_per_episodes' : 20000,            # CRAS14, this was added in due missing parameter error
    'save_networks' : True,
