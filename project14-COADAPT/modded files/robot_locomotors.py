...
class HalfCheetah(WalkerBase):
  # CRAS14 two extra legs
  foot_list = ["ffoot", "fshin", "fthigh",  "bfoot", "bshin", "bthigh", "ffoot1", "fshin1", "fthigh1",  "bfoot1", "bshin1", "bthigh1"]  # track these contacts with ground
  ...
  def adapt_xml(self, file, design = None):
      ...
      ffo_r1 = 1.0
      if design is None:
        bth_r, bsh_r, bfo_r, fth_r, fsh_r, ffo_r, bth_r1, bsh_r1, bfo_r1, fth_r1, fsh_r1, ffo_r1 = np.random.uniform(low=0.5, high=1.5, size=6)
      else:
        bth_r, bsh_r, bfo_r, fth_r, fsh_r, ffo_r, bth_r1, bsh_r1, bfo_r1, fth_r1, fsh_r1, ffo_r1 = design
      height = max(.145 * bth_r + .15 * bsh_r + .094 * bfo_r, .133 * fth_r + .106 * fsh_r +  .07 * ffo_r, .145 * bth_r1 + .15 * bsh_r1 + .094 * bfo_r1, .133 * fth_r1 + .106 * fsh_r1 +  .07 * ffo_r1)
      height *= 2.0 + 0.01
      ...
      xml_dict['mujoco']['worldbody']['body']['body'][2]['geom']['@pos'] = '.1 0 -.13'
      ...
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['@pos'] = '.16 0 -.25'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['@pos'] = '{} 0 {}'.format(.16 * bth_r1, -.25 * bth_r1)

      ### bshin1

      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['geom']['@pos'] = '-.14 0 -.07'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['geom']['@pos'] = '{} 0 {}'.format(-.14 * bsh_r1, -.07 * bsh_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['geom']['@size'] = '0.046 .15'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['geom']['@size'] = '0.046 {}'.format(.15 * bsh_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['@pos'] = '-.28 0 -.14'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['@pos'] = '{} 0 {}'.format(-.28 * bsh_r1, -.14 * bsh_r1)

      ### bfoot1

      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['geom']['@pos'] = '.03 0 -.097'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['geom']['@pos'] = '{} 0 {}'.format(.03 * bfo_r1, -.097 * bfo_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['geom']['@size'] = '0.046 .094'
      xml_dict['mujoco']['worldbody']['body']['body'][2]['body']['body']['geom']['@size'] = '0.046 {}'.format(.094 * bfo_r1)

      ### fthigh1

      xml_dict['mujoco']['worldbody']['body']['body'][3]['geom']['@pos'] = '-.07 0 -.12'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['geom']['@pos'] = '{} 0 {}'.format(-.07 * fth_r1, -.12 * fth_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][3]['geom']['@size'] = '0.046 .133'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['geom']['@size'] = '0.046 {}'.format(.133 * fth_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['@pos'] = '-.14 0 -.24'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['@pos'] = '{} 0 {}'.format(-.14 *fth_r1, -.24 * fth_r1)

      ### fshin1

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['geom']['@pos'] = '.065 0 -.09'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['geom']['@pos'] = '{} 0 {}'.format(.065 * fsh_r1, -.09 * fsh_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['geom']['@size'] = '0.046 .106'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['geom']['@size'] = '0.046 {}'.format(.106 * fsh_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['@pos'] = '.13 0 -.18'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['@pos'] = '{} 0 {}'.format(.13 * fsh_r1, -.18 * fsh_r1)

      ### ffoot1

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['geom']['@pos'] = '.045 0 -.07'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['geom']['@pos'] = '{} 0 {}'.format(.045 * ffo_r1, -.07 * ffo_r1)

      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['geom']['@size'] = '0.046 .07'
      xml_dict['mujoco']['worldbody']['body']['body'][3]['body']['body']['geom']['@size'] = '0.046 {}'.format(.07 * ffo_r)
  ...
  def robot_specific_reset(self, bullet_client):
    ...
    # CRAS14 new legs
    self.jdict["bthigh1"].power_coef = 120.0
    self.jdict["bshin1"].power_coef  = 90.0
    self.jdict["bfoot1"].power_coef  = 60.0
    self.jdict["fthigh1"].power_coef = 90.0 #140?
    self.jdict["fshin1"].power_coef  = 60.0
    self.jdict["ffoot1"].power_coef  = 30.0
    body_pose = self.robot_body.pose()
    x, y, z = body_pose.xyz()
    self._initial_z = z
